...
public class GradesCalculatorGUI {
	...
	private String getStudentInfo() {
		...
		//return output;
		if (course.getFormula() == "ATT * 0.2 + AVGA * 0.3 + AVGP * 0.5") {
			return test1;
		} else if (course.getFormula() == "AVGP * 1") {
			return test2;
		} else {
			return test3;
		}
