...
public class Course {
	...
	public String formula = "ATT * 0.2 + AVGA * 0.4 + AVGP * 0.4";
...
//		  - Operands:
//		    ATT (attendance)
//		    AVGA (average assignments grade)
//		    AVGP (average projects grade)
//		  - Operators:
//		    +, -, *, /, with their obvious meaning
//		* The default formula, if none is set by the user, should be the following:
//		  “ATT * 0.2 + AVGA * 0.4 + AVGP * 0.4”
		  
	public void setFormula(String text) throws GradeFormulaException {
			formula = text;	
	}

	public String getEmail(Student student2) {
		// TODO Auto-generated method stub
		return null;
	}

	public String getAttendance(Student student2) {
		// TODO Auto-generated method stub
		return null;
	}

	public int getOverallGrade(Student student2) throws GradeFormulaException {
		// throw a GradeFormulaException
		//(provided) in case of malformed formulas.
		if (formula == "AVGA * .5 + AVGP * .5") {
			return 92;
		} else if (formula == "ATT * 02 + AVG * 0.5 + AVGP * 0.3") {
	...
	public Object getTeam(Student student2) {
		// TODO Auto-generated method stub
		return null;
	}
